...
__global__ void conv_forward_kernel_ConstantMemRestrict_Unroll_layer1(float* __restrict__ output, const float* __restrict__ input, const float* __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    /*
    Function paramter definitions:
    output - output
...
__global__ void conv_forward_kernel_ConstantMemRestrict_Unroll_layer2(float* __restrict__ output, const float* __restrict__ input, const float* __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    /*
    Function paramter definitions:
    output - output
...
__global__ void conv_forward_kernel_ConstantMem_SharedMemUnroll_layer1_C1(float* __restrict__ output, const float* __restrict__ input, const float* __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    /*
    Function paramter definitions:
    output - output
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int B, const int M, const int C, const int H, const int W, const int K, const int S)
{
    ...
    if(kernelFlag){
        ...
        if(C==1){
            conv_forward_kernel_ConstantMem_SharedMemUnroll_layer1_C1<<<dimGrid, dimBlock, sharedMemConvSize>>>(device_output, device_input, device_mask, B, M, C, H, W, K, S);
        }
        else{
            conv_forward_kernel_ConstantMem_SharedMemUnroll<<<dimGrid, dimBlock, sharedMemConvSize>>>(device_output, device_input, device_mask, B, M, C, H, W, K, S);
        }
